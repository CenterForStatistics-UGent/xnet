...
vignette: >
  %\VignetteIndexEntry{S4 class structure of the xnet package}
 ...
 * the object stores the eigendecompositions of the gram matrices for the row
 and column. These are stored as `gramData` objects, allowing for conversion
 of new data if needed. 
